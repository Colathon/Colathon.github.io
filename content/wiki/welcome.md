...
- [Computer Graphics](/wiki?tag=Computer+Graphics) - Research on [Mesh Reduction](/wiki/mesh-reduction-knodt), [Discrete CT Inverse Rendering](/wiki/discrete-ct-inverse-rendering), rendering, and generative models like DDPM.
