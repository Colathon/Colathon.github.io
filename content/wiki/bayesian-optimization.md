...
在最新的生成式 AI 研究中，**[GimmBO](/reading/gimmbo)** (Generative Image Model Merging via BO) 展示了 PBO 的强大潜力。它将 PBO 应用于扩散模型（Diffusion Models）的适配器（Adapter/LoRA）权重优化。
...
## 相关链接
- [GimmBO: 交互式图像模型合并](/reading/gimmbo) - PBO 在扩散模型中的具体实践。
